==================================================================
Michał Kaftanowicz
Assignment: Getting and Cleaning Data Course Project, Coursera
==================================================================

This repo contains data collected from the accelerometers from the Samsung Galaxy S smartphone and a script that transforms data to provide a useful summary, according to the following steps:
